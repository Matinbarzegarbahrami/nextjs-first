...
export default async function Article(
    ...
    <p>Le Lorem Ipsum est simplement du faux texte employ dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de limprimerie depuis les annes 1500, quand un imprimeur anonyme assembla ensemble des morceaux de texte pour raliser un livre spécimen de polices de texte. Il na pas fait que survivre cinq sicles, mais sest aussi adapté à la bureautique informatique, sans que son contenu nen soit modifié. Il a été popularisé dans les années 1960 grâce à la vente de feuilles Letraset contenant des passages du Lorem Ipsum, et, plus récemment, par son inclusion dans des applications de mise en page de texte, comme Aldus PageMaker.</p>
    </div>
    );
};
}
